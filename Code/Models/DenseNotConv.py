...
class Model:
    ...
    def __init__(self, imageSize, charList, maxTextLength, mustRestore=False):
        ...
        # Debuging CTC
        self.rnnOutput = tf.nn.softmax(tf.transpose(rnnOut3d, [1, 0, 2]),axis =2)
    ...
    def setupRNN(self, rnnIn4d):
        ...
        concat = tf.concat([forward,backward],2)
        dense = tf.keras.layers.Dense(units = len(self.charList) + 1)(concat)
        print(dense.shape)
        return dense
    ...
    def setupTF(self):
        ...
        modelDir = 'drive/My Drive/Licenta/Cod/Checkpoints/IAM/Dense/'
    ...
    def save(self):
        """ Save model to file """
        self.snapID += 1
        self.saver.save(self.sess, 'drive/My Drive/Licenta/Cod/Checkpoints/IAM/Dense/',
