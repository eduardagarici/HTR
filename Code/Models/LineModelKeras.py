...
class Model:
    ...
    def setupRNN(self, rnnIn4d):
        ...
        print("BILSTM:", bidirectional.shape)
        bidirectional = tf.expand_dims(bidirectional, 2)
        conv = tf.keras.layers.Conv2D(filters = self.maxTextLength + 1, kernel_size = 1, padding= 'SAME')(bidirectional)
    ...
    def setupTF(self):
        ...
        modelDir = 'drive/My Drive/Licenta/Cod/Checkpoints/IAM'
    ...
    def save(self):
        """ Save model to file """
        self.snapID += 1
        self.saver.save(self.sess, 'drive/My Drive/Licenta/Cod/Checkpoints/IAM/CTC',
